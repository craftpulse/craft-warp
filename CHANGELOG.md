...
- Documented that Warp's baseline caps the email inputs at 24rem and that a `w-full`-style width utility does not lift a max-width cap, alongside the existing note about resets stripping the digit boxes' borders.
